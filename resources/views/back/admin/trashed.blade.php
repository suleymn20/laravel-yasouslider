  ...
  <div class="card shadow mb-4">
    <div class="card-header py-4">
      <h6 class="m-0 font-weight-bold text-primary">@yield('title')
        ...
        <a href="{{route('admin.yoneticiler.index')}}" class="btn btn-primary btn-sm"><i class="fa fa-arrow-left"></i> Yöneticilere Geri Dön</a>
      </h6>
    </div>
    <div class="card-body">
        ...
        <table class="table table-hover table-dark rounded shadow" width="100%" cellspacing="0">
          ...
          <tbody id="myTable">
            <tr>
              ...
              <td>
                <a href="{{route('admin.recover.admin',$admin->id)}}" title="Kurtar" class="btn btn-sm btn-primary"><i class="fa fa-recycle"></i> </a>
